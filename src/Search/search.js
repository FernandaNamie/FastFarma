    ...
    <div>
        ...
        <Row>
          ...
          {remedios.map((remedio, idx) => {
            return (
              <Card nome={remedio.nome} preco={remedio.preco} toggleDrawer={toggleDrawer}
                  handleClickLess={handleClickLess} handleClickPlus={handleClickPlus}
                  index={idx} quantidade={pedidos[idx].quantidade} />
            )
          })}
          </Cards>
          </Col>
        ...
        <React.Fragment key={'right'}>
          ...
          >
            <TemporaryDrawer value={state} toggleDrawer={toggleDrawer} pedidos={pedidos}
              handleClickLess={handleClickLess} handleClickPlus={handleClickPlus}
